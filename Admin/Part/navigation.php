...
<img src="../assets/gitasav.jpg" width="50"> 
</a> 
       ...
       <a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown">
        Master 
         ...
         <a class="dropdown-item" href="index.php?p=formInputUser.php">Data User</a>
          <a class="dropdown-item" href="index.php?p=formBarang.php">Data Barang</a>
           </div> 
           </li> 
           <!-- Dropdown Transaksi --> 
           <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown">
             ...
             <div class="dropdown-menu">
              <a class="dropdown-item" href="index.php?p=formTransaksi.php">Form Transaksi</a>
              <a class="dropdown-item" href="index.php?p=dataTransaksi.php">Data Transaksi</a>
               </div> 
               </li>
            <li class="nav-item"> <a class="nav-link" href="index.php?p=loginForm.php">Logout</a> 
            </li> 
            </ul> 
