<h3 class="text-center text-dark mb-5 mt-3"><b>FORM INPUT DATA TRANSAKSI</b></h3>
<form action="index.php?p=prosesInsertTransaksi.php" id="form1" method="POST">
    <div class="form-group row">
        <label class="control-label col-sm-3 text-dark">No Transaksi :</label>
        <div class="col-sm-9">
    ...
    <div class="form-group row">
        <label class="control-label col-sm-3 text-dark">Tanggal :</label>
        <div class="col-sm-9">
            <input type="date" name="tanggalTransaksi" class="form-control" id="tanggal-transaksi" value="<?php echo date('Y-m-j');?>" readonly>
        </div>
    </div>
    <div class="form-group row">
        <label class="control-label col-sm-3 text-dark">ID User(Kasir) / Nama User(Kasir)</label>
        <div class="col-sm-2">
            <input type="text" name="idUser" class="form-control" id="id-user" value="18" readonly>
        </div>
        <div class="col-sm-7">
            <input type="text" name="namaUser" class="form-control" id="nama-user" value="shafirah" readonly>
        </div>
    </div>
    <hr>
    <div class="row">
